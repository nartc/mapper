...
sidebar_label: Mapping Configurations
sidebar_position: 4
---
...
AutoMapper supports [TODO: Auto Flattening docs](.) out of the box with the concept of [TODO: Naming Conventions docs](.). With that in mind, let's provide a `NamingConvention` for `Mapping<Bio, BioDto>` by using yet another `MappingConfiguration` function: `namingConventions()`
...
-   [TODO: Auto Flattening](.) with [TODO: Naming Conventions](.)
-   [TODO: Type Converter](.) allows for using the same conversion for the same pair of types.
...
<iframe
    src="https://stackblitz.com/edit/angular-ivy-ckxazb?ctl=1&devToolsHeight=100&embed=1&view=preview"
    frameBorder="0"
    width="100%"
    height="500"
/>
