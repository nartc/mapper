...
Simple asynchronous operations should be fine with this approach. However due to [TODO: Fake Async docs](.), we should **NOT** use AutoMapper for a particular pair of models if those models require some heavy and complex asynchronous operations.
