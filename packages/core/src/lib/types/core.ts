...
export interface Mapper {
  ...
  addTypeConverter<
    TSourceType extends PrimitiveConstructorExtended = PrimitiveConstructorExtended,
    TDestinationType extends PrimitiveConstructorExtended = PrimitiveConstructorExtended
  >(
    source: TSourceType,
